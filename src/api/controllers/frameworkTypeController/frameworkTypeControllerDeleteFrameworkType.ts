...
export const frameworkTypeControllerDeleteFrameworkType: IFrameworkTypeControllerDeleteFrameworkType =
  async ({ frameworkTypeId }) => {
    ...
    try {
       ...
       * 'adminStatusId' field.
       */
      const frameworkTypeModel = await FrameworkTypeModel.findOneAndUpdate(
        {
          _id: frameworkTypeId,
        },
        {
       ...
       */
      stat.error = false;
      stat.payload = { frameworkTypeId: frameworkTypeModel.id };
       ...
       * 'IFrameworkTypeControllerDeleteFrameworkTypeOutput'.
       */
