...
import {
  IResourceTypeControllerUpdateResourceTypeOutputError as IControllerError,
  IResourceTypeControllerUpdateResourceTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					resourceTypeRouterUpdateResourceType
 *
 * @description		The 'updateResourceType' router for 'resourceType', whose expected
 *                inputs have been defined within the following schema:
 *                'resourceTypeValidationSchemaUpdateResourceType'.
 *
...
export const resourceTypeRouterUpdateResourceType = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'resourceTypeValidationSchemaUpdateResourceType'.
      ...
      const stat = await resourceTypeController.updateResourceType({
        resourceTypeId,
        payload,
      });
