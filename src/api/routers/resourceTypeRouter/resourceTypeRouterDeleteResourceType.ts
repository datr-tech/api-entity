...
import {
  IResourceTypeControllerDeleteResourceTypeOutputError as IControllerError,
  IResourceTypeControllerDeleteResourceTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					resourceTypeRouterDeleteResourceType
 *
 * @description		The 'deleteResourceType' router for 'resourceType', whose expected
 *                inputs have been defined within the following schema:
 *                'resourceTypeValidationSchemaDeleteResourceType'.
 *
 ...
 *                controller, 'resourceTypeController', which, when successful, will return
 ...
 *                | Server error                | 500               |
 */
export const resourceTypeRouterDeleteResourceType = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'resourceTypeValidationSchemaDeleteResourceType'.
       ...
       * to 'resourceTypeController'.
       */

      const validatedParams = matchedData<IResourceTypeModel>(req);
      const stat = await resourceTypeController.deleteResourceType(validatedParams);
       ...
       * 'resourceTypeId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ resourceTypeId: controllerResponsePayload['resourceTypeId'] });
    } catch (error) {
      /*
