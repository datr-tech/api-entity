...
import {
  IFrameworkControllerDeleteFrameworkOutputError as IControllerError,
  IFrameworkControllerDeleteFrameworkOutputSuccess as IControllerSuccess,
...
/**
 * @name					frameworkRouterDeleteFramework
 *
 * @description		The 'deleteFramework' router for 'framework', whose expected
 *                inputs have been defined within the following schema:
 *                'frameworkValidationSchemaDeleteFramework'.
 *
 ...
 *                | Server error                | 500               |
 */
export const frameworkRouterDeleteFramework = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'frameworkValidationSchemaDeleteFramework'.
      ...
      const stat = await frameworkController.deleteFramework(validatedParams);
       ...
       * 'frameworkId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ frameworkId: controllerResponsePayload['frameworkId'] });
    } catch (error) {
      /*
