...
import {
  IFrameworkControllerCreateFrameworkOutputError as IControllerError,
  IFrameworkControllerCreateFrameworkOutputSuccess as IControllerSuccess,
...
/**
 * @name					frameworkRouterCreateFramework
 *
 * @description		The 'createFramework' router for 'framework', whose expected
 *                inputs have been defined within the following schema:
 *                'frameworkValidationSchemaCreateFramework'.
 *
...
export const frameworkRouterCreateFramework = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'frameworkValidationSchemaCreateFramework'.
      ...
      const stat = await frameworkController.createFramework(validatedParams);
