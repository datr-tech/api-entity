...
import {
  IFrameworkControllerUpdateFrameworkOutputError as IControllerError,
  IFrameworkControllerUpdateFrameworkOutputSuccess as IControllerSuccess,
...
/**
 * @name					frameworkRouterUpdateFramework
 *
 * @description		The 'updateFramework' router for 'framework', whose expected
 *                inputs have been defined within the following schema:
 *                'frameworkValidationSchemaUpdateFramework'.
 *
...
export const frameworkRouterUpdateFramework = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'frameworkValidationSchemaUpdateFramework'.
      ...
      const stat = await frameworkController.updateFramework({ frameworkId, payload });
