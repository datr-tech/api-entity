...
import {
  IEndpointTypeControllerUpdateEndpointTypeOutputError as IControllerError,
  IEndpointTypeControllerUpdateEndpointTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					endpointTypeRouterUpdateEndpointType
 *
 * @description		The 'updateEndpointType' router for 'endpointType', whose expected
 *                inputs have been defined within the following schema:
 *                'endpointTypeValidationSchemaUpdateEndpointType'.
 *
...
export const endpointTypeRouterUpdateEndpointType = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'endpointTypeValidationSchemaUpdateEndpointType'.
      ...
      const stat = await endpointTypeController.updateEndpointType({
        endpointTypeId,
        payload,
      });
