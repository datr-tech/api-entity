...
import {
  IEndpointTypeControllerDeleteEndpointTypeOutputError as IControllerError,
  IEndpointTypeControllerDeleteEndpointTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					endpointTypeRouterDeleteEndpointType
 *
 * @description		The 'deleteEndpointType' router for 'endpointType', whose expected
 *                inputs have been defined within the following schema:
 *                'endpointTypeValidationSchemaDeleteEndpointType'.
 *
 ...
 *                | Server error                | 500               |
 */
export const endpointTypeRouterDeleteEndpointType = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'endpointTypeValidationSchemaDeleteEndpointType'.
      ...
      const stat = await endpointTypeController.deleteEndpointType(validatedParams);
       ...
       * 'endpointTypeId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ endpointTypeId: controllerResponsePayload['endpointTypeId'] });
    } catch (error) {
      /*
