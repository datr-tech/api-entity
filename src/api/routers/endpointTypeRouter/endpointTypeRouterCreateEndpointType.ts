...
import {
  IEndpointTypeControllerCreateEndpointTypeOutputError as IControllerError,
  IEndpointTypeControllerCreateEndpointTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					endpointTypeRouterCreateEndpointType
 *
 * @description		The 'createEndpointType' router for 'endpointType', whose expected
 *                inputs have been defined within the following schema:
 *                'endpointTypeValidationSchemaCreateEndpointType'.
 *
...
export const endpointTypeRouterCreateEndpointType = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'endpointTypeValidationSchemaCreateEndpointType'.
      ...
      const stat = await endpointTypeController.createEndpointType(validatedParams);
