...
import {
  IServiceControllerUpdateServiceOutputError as IControllerError,
  IServiceControllerUpdateServiceOutputSuccess as IControllerSuccess,
...
/**
 * @name					serviceRouterUpdateService
 *
 * @description		The 'updateService' router for 'service', whose expected
 *                inputs have been defined within the following schema:
 *                'serviceValidationSchemaUpdateService'.
 *
...
export const serviceRouterUpdateService = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'serviceValidationSchemaUpdateService'.
      ...
      const stat = await serviceController.updateService({ serviceId, payload });
