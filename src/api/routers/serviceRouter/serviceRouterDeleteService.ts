...
import {
  IServiceControllerDeleteServiceOutputError as IControllerError,
  IServiceControllerDeleteServiceOutputSuccess as IControllerSuccess,
...
/**
 * @name					serviceRouterDeleteService
 *
 * @description		The 'deleteService' router for 'service', whose expected
 *                inputs have been defined within the following schema:
 *                'serviceValidationSchemaDeleteService'.
 *
 ...
 *                | Server error                | 500               |
 */
export const serviceRouterDeleteService = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'serviceValidationSchemaDeleteService'.
      ...
      const stat = await serviceController.deleteService(validatedParams);
