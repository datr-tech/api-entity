...
import {
  IResourceControllerUpdateResourceOutputError as IControllerError,
  IResourceControllerUpdateResourceOutputSuccess as IControllerSuccess,
...
/**
 * @name					resourceRouterUpdateResource
 *
 * @description		The 'updateResource' router for 'resource', whose expected
 *                inputs have been defined within the following schema:
 *                'resourceValidationSchemaUpdateResource'.
 *
...
export const resourceRouterUpdateResource = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'resourceValidationSchemaUpdateResource'.
      ...
      const stat = await resourceController.updateResource({ resourceId, payload });
