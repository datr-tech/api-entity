...
import {
  IResourceControllerCreateResourceOutputError as IControllerError,
  IResourceControllerCreateResourceOutputSuccess as IControllerSuccess,
...
/**
 * @name					resourceRouterCreateResource
 *
 * @description		The 'createResource' router for 'resource', whose expected
 *                inputs have been defined within the following schema:
 *                'resourceValidationSchemaCreateResource'.
 *
...
export const resourceRouterCreateResource = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'resourceValidationSchemaCreateResource'.
      ...
      const stat = await resourceController.createResource(validatedParams);
