...
import {
  IResourceControllerDeleteResourceOutputError as IControllerError,
  IResourceControllerDeleteResourceOutputSuccess as IControllerSuccess,
...
/**
 * @name					resourceRouterDeleteResource
 *
 * @description		The 'deleteResource' router for 'resource', whose expected
 *                inputs have been defined within the following schema:
 *                'resourceValidationSchemaDeleteResource'.
 *
 ...
 *                | Server error                | 500               |
 */
export const resourceRouterDeleteResource = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'resourceValidationSchemaDeleteResource'.
      ...
      const stat = await resourceController.deleteResource(validatedParams);
       ...
       * 'resourceId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ resourceId: controllerResponsePayload['resourceId'] });
    } catch (error) {
      /*
