...
import {
  IFrameworkTypeControllerUpdateFrameworkTypeOutputError as IControllerError,
  IFrameworkTypeControllerUpdateFrameworkTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					frameworkTypeRouterUpdateFrameworkType
 *
 * @description		The 'updateFrameworkType' router for 'frameworkType', whose expected
 *                inputs have been defined within the following schema:
 *                'frameworkTypeValidationSchemaUpdateFrameworkType'.
 *
...
export const frameworkTypeRouterUpdateFrameworkType = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'frameworkTypeValidationSchemaUpdateFrameworkType'.
      ...
      const stat = await frameworkTypeController.updateFrameworkType({
        frameworkTypeId,
        payload,
      });
