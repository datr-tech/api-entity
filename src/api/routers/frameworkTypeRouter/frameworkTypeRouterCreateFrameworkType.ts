...
import {
  IFrameworkTypeControllerCreateFrameworkTypeOutputError as IControllerError,
  IFrameworkTypeControllerCreateFrameworkTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					frameworkTypeRouterCreateFrameworkType
 *
 * @description		The 'createFrameworkType' router for 'frameworkType', whose expected
 *                inputs have been defined within the following schema:
 *                'frameworkTypeValidationSchemaCreateFrameworkType'.
 *
...
export const frameworkTypeRouterCreateFrameworkType = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'frameworkTypeValidationSchemaCreateFrameworkType'.
      ...
      const stat = await frameworkTypeController.createFrameworkType(validatedParams);
