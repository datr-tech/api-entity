...
import {
  IEndpointControllerUpdateEndpointOutputError as IControllerError,
  IEndpointControllerUpdateEndpointOutputSuccess as IControllerSuccess,
...
/**
 * @name					endpointRouterUpdateEndpoint
 *
 * @description		The 'updateEndpoint' router for 'endpoint', whose expected
 *                inputs have been defined within the following schema:
 *                'endpointValidationSchemaUpdateEndpoint'.
 *
...
export const endpointRouterUpdateEndpoint = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'endpointValidationSchemaUpdateEndpoint'.
      ...
      const stat = await endpointController.updateEndpoint({ endpointId, payload });
